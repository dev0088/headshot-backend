...
swagger_schema_view = get_swagger_view(title='Headshot API')

schema_view = get_schema_view(
   openapi.Info(
      title="Headshot API",
      default_version='v1',
      description="RESTful API for www.headshot.com",
      terms_of_service="http://www.headshot/terms/",
      contact=openapi.Contact(email="alaric@headshot.com"),
      license=openapi.License(name="headshot.com"),
   ),
   # validators=['flex', 'ssv'],
   public=True,
...
# schema_view = get_swagger_view(title='Headshot API')
