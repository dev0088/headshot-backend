# Generated by Django 2.0.5 on 2019-03-27 19:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=14)),
                ('source', models.CharField(blank=True, default='', max_length=255)),
                ('description', models.TextField(blank=True, default='', max_length=255)),
                ('statement_descriptor', models.TextField(blank=True, default='', max_length=255)),
                ...
                ('headshot', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headshot_strype_payments', to='headshot.Headshot')),
            ],
            options={
